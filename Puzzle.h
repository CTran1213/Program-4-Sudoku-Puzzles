...
//by the GA framework. Puzzle class must define stream I/O helper methods (operator<<()
// and operator>>() to call these methods) and the subclasses must implement them.
#pragma once
#include<iostream>
#include <vector>
using namespace std;
