...
class SudokuFitness: public Fitness
{
   public:
      ...
      //This method takens in a puzzle and counts the number of conflicts 
      //in each row, column, and box. The conflicts are then added and that
      // is the fitness number of the puzzle
   ...
   private:
      //This method accepts the position of the top left hand side of a 3-by-3
      // sudoku box and the sudoku array. It then iterates through the box and
